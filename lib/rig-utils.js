...
function mapModeRigctld(mode, freqHz) {
  ...
  if (m === 'DIGU' || m === 'PKTUSB' || m === 'FT8' || m === 'FT4' || m === 'FT2' || m === 'PSK31' || m === 'PSK') return 'PKTUSB';
...
function mapModeCiv(mode, freqHz) {
  ...
  if (m === 'DIGU' || m === 'PKTUSB' || m === 'FT8' || m === 'FT4' || m === 'FT2' || m === 'PSK31' || m === 'PSK') return 0x01;
