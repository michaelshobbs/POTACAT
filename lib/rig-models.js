...
const RIG_MODELS = {
  ...
  'IC-705': {
    ...
    caps: { nb: true, atu: true, vfo: true, filter: true, filterType: 'civ', rfgain: true, txpower: true, power: true, preamp: true, att: true, comp: true, nr: true, anf: true, vox: true, agc: true },
  ...
  'IC-7100': {
    ...
    caps: { nb: true, atu: false, vfo: true, filter: true, filterType: 'civ', rfgain: true, txpower: true, power: true, preamp: true, att: true, comp: true, nr: true, anf: true, vox: true, agc: true },
  ...
  'FLEX-6300': {
    ...
    caps: { nb: true, atu: true, vfo: false, filter: true, filterType: 'arbitrary', rfgain: true, txpower: true, power: false, preamp: false, att: false, comp: true, nr: true, anf: true, vox: true, agc: true },
