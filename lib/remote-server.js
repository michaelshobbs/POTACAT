...
`;
  ...
  /** Current shack radio status snapshot — read by main.js when assembling a
   *  diagnostic-snapshot (the server owns this; main owns version/tunnel/log). */
  getRadioStatus() {
    return this._radioStatus || null;
  }
